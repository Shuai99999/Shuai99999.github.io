...
// Only zoom map when Ctrl + wheel; handles zoom and disables Leaflet's built-in
...
// Wrapper that blocks wheel from reaching the map unless Ctrl is held (capture phase)
